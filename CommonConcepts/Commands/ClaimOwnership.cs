...
namespace dk.itu.game.msc.cgol.CommonConcepts.Commands
{
    public class ClaimOwnership : ICommand
    {
        ...
        [Concept(Description = "Set the owner of each card in a collection to the same owner of the collection. If the collection is not specified, the current players hand is assumed.")]
